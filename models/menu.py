...
response.menu = [
    ...
    (T('Research planning information'), True, None, [
        ...
        (T('Bed availability'), True, URL('visits', 'bed_availability'), []),
        LI(_class="divider"),
...
user_actions = [(T('Registered users'), True, None, [
                ...
                (T('View research visits'), True, URL('visits', 'research_visits'), []),
                ...
                (T('Your health and safety info'), True, URL('visits', 'health_and_safety'), []),
                (T('Propose a research visit'), True, URL('visits', 'new_research_visit'), []),
                (T('Reserve bed space'), True, URL('visits', 'reserve_beds'), []),
...
if (auth.user_id != None) and (auth.has_membership(role = 'admin')):
    response.menu += [('Admin',  False,  None, [
                        ...
                        (T('Manage bed reservations'), True, URL('visits', 'manage_bed_reservations'), []),
                        ...
                        (T('> Research visits') + n_dict['vis'], True, URL('visits', 'administer_new_research_visits'), []),
                        (T('> Bed reservations') + n_dict['bed'], True, URL('visits', 'administer_reserve_beds'), []),
